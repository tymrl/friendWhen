...
export const mockData = [
  {
    ...
    lastSeen: moment().subtract(6, "days"),
    daysPerContact: 4,
  },
  {
    name: "Egwene al'Vere",
    id: "afcdcf83-589d-488f-9cb7-babc33b2c0f8",
    lastSeen: moment().subtract(8, "days"),
    daysPerContact: 4,
  },
  {
    name: "Perrin Aybara",
  ...
  },
  {
    ...
    lastSeen: moment().subtract(5, "days"),
    daysPerContact: 4,
  },
  {
    name: "Min Farshaw",
    id: "ae32fee4-b5ef-4481-86dd-069719493f86",
    lastSeen: moment().subtract(7, "days"),
    daysPerContact: 4,
  },
  {
    name: "Elayne Trakand",
    id: "f65a7d75-5764-45ba-87e3-425df00cf298",
    lastSeen: moment().subtract(4, "days"),
    daysPerContact: 4,
  },
  {
    name: "Aviendha",
    id: "2737f305-de5f-4f8a-9da7-45721b479c00",
    lastSeen: moment().subtract(1, "days"),
    daysPerContact: 4,
  },
  {
    name: "Thom Merrilin",
    id: "e84872a5-845a-453b-bae2-00ba92433dbc",
    lastSeen: moment().subtract(17, "days"),
    daysPerContact: 8,
  },
];
